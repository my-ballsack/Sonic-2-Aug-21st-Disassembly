SoundC4_BossExplosion_Header:
	smpsHeaderStartSong 2
	smpsHeaderVoice     SoundC4_BossExplosion_Voices
	smpsHeaderTempoSFX  $01
	smpsHeaderChanSFX   $01

	smpsHeaderSFXChannel cFM5, SoundC4_BossExplosion_FM5,	$00, $00

; FM5 Data
SoundC4_BossExplosion_FM5:
	smpsSetvoice        $00
	dc.b	nA0, $22
	smpsStop

SoundC4_BossExplosion_Voices:
;	Voice $00
;	$FA
