SoundAD_InhalingBubble_Header:
	smpsHeaderStartSong 2, 1
	smpsHeaderVoice     SoundAD_InhalingBubble_Voices
	smpsHeaderTempoSFX  $01
	smpsHeaderChanSFX   $01

	smpsHeaderSFXChannel cFM5, SoundAD_InhalingBubble_FM5,	$0E, $00

; FM5 Data
SoundAD_InhalingBubble_FM5:
	smpsSetvoice        $00
