SoundA1_Checkpoint_Header:
	smpsHeaderStartSong 2
	smpsHeaderVoice     SoundA1_Checkpoint_Voices
	smpsHeaderTempoSFX  $01
	smpsHeaderChanSFX   $01

	smpsHeaderSFXChannel cFM5, SoundA1_Checkpoint_FM5,	$00, $01

SoundA1_Checkpoint_Voices:
;	Voice $00
;	$3C
