SoundBB_DoorSlam_Header:
	smpsHeaderStartSong 2
	smpsHeaderVoice     SoundBB_DoorSlam_Voices
	smpsHeaderTempoSFX  $01
	smpsHeaderChanSFX   $01

	smpsHeaderSFXChannel cFM5, SoundBB_DoorSlam_FM5,	$F4, $00

; FM5 Data
SoundBB_DoorSlam_FM5:
	smpsSetvoice        $00
	dc.b	nD2, $04, nRst, nG2, $06
	smpsStop

SoundBB_DoorSlam_Voices:
;	Voice $00
;	$3C
