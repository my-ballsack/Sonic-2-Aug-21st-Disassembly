SoundAE_LavaBall_Header:
	smpsHeaderStartSong 2
	smpsHeaderVoice     SoundAE_B3_Voices
	smpsHeaderTempoSFX  $01
	smpsHeaderChanSFX   $02

	smpsHeaderSFXChannel cFM5, SoundAE_LavaBall_FM5,	$00, $00
	smpsHeaderSFXChannel cPSG3, SoundAE_LavaBall_PSG3,	$00, $00

; FM5 Data
SoundAE_LavaBall_FM5:
	smpsSetvoice        $00
	dc.b	nRst, $01
...
; PSG3 Data
SoundAE_LavaBall_PSG3:
	smpsPSGvoice        $00
	dc.b	nRst, $0B
	smpsPSGform         $E7
	dc.b	nMaxPSG, $01, smpsNoAttack

SoundAE_LavaBall_Loop00:
	dc.b	$02
	smpsPSGAlterVol     $01
	dc.b	smpsNoAttack
	smpsLoop            $00, $10, SoundAE_LavaBall_Loop00
	smpsStop
