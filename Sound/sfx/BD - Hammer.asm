SoundBD_Hammer_Header:
	smpsHeaderStartSong 2
	smpsHeaderVoice     SoundBD_Hammer_Voices
	smpsHeaderTempoSFX  $01
	smpsHeaderChanSFX   $02

	smpsHeaderSFXChannel cFM5, SoundBD_Hammer_FM5,	$10, $0A
	smpsHeaderSFXChannel cFM4, SoundBD_Hammer_FM4,	$00, $00
