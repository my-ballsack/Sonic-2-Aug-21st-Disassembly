SoundA5_BlockPush_Header:
	smpsHeaderStartSong 2
	smpsHeaderVoice     SoundA5_BlockPush_Voices
	smpsHeaderTempoSFX  $01
	smpsHeaderChanSFX   $01

	smpsHeaderSFXChannel cFM5, SoundA5_BlockPush_FM5, $00, $00

; FM5 Data
SoundA5_BlockPush_FM5:
	smpsSetvoice        $00
	dc.b	nRst, $01, nBb0, $0A, nRst, $02
	smpsStop

SoundA5_BlockPush_Voices:
;	Voice $00
;	$FA
