SoundB2_Drown_Header:
	smpsHeaderStartSong 2, 1
	smpsHeaderVoice     SoundB2_Drown_Voices
	smpsHeaderTempoSFX  $01
	smpsHeaderChanSFX   $02

	smpsHeaderSFXChannel cFM4, SoundB2_Drown_FM4,	$0C, $04
	smpsHeaderSFXChannel cFM5, SoundB2_Drown_FM5,	$0E, $02
...
SoundB2_Drown_Loop01:
	dc.b	nA0, $05, $05
	smpsAlterVol        $03
	smpsLoop            $00, $0A, SoundB2_Drown_Loop01
	smpsStop
...
SoundB2_Drown_Loop00:
	dc.b	nC1, $04, $05
	smpsAlterVol        $03
	smpsLoop            $00, $0A, SoundB2_Drown_Loop00
	smpsStop

SoundB2_Drown_Voices:
;	Voice $00
;	$35
