SoundDD_ArrowStick_Header:
	smpsHeaderStartSong 2
	smpsHeaderVoice     SoundDD_ArrowStick_Voices
	smpsHeaderTempoSFX  $01
	smpsHeaderChanSFX   $01

	smpsHeaderSFXChannel cFM5, SoundDD_ArrowStick_FM5,	$00, $00

; FM5 Data
SoundDD_ArrowStick_FM5:
	smpsSetvoice        $00
	dc.b	nEb5, $04
	smpsStop

SoundDD_ArrowStick_Voices:
;	Voice $00
;	$28
