SoundC5_TallyEnd_Header:
	smpsHeaderStartSong 2
	smpsHeaderVoice     SoundC5_TallyEnd_Voices
	smpsHeaderTempoSFX  $01
	smpsHeaderChanSFX   $03

	smpsHeaderSFXChannel cFM5, SoundC5_TallyEnd_FM5,	$00, $00
	smpsHeaderSFXChannel cFM4, SoundC5_TallyEnd_FM4,	$00, $00
	smpsHeaderSFXChannel cPSG3, SoundC5_TallyEnd_PSG3,	$00, $00

; FM5 Data
SoundC5_TallyEnd_FM5:
	smpsSetvoice        $00
	dc.b	nA0, $08, nRst, $02, nA0, $08
	smpsStop

; FM4 Data
SoundC5_TallyEnd_FM4:
	smpsSetvoice        $01
	dc.b	nRst, $12, nA5, $55
	smpsStop

; PSG3 Data
SoundC5_TallyEnd_PSG3:
	smpsPSGvoice        fTone_02
	smpsPSGform         $E7
	dc.b	nRst, $02, nF5, $05, nG5, $04, nF5, $05, nG5, $04
	smpsStop

SoundC5_TallyEnd_Voices:
;	Voice $00
;	$3B
