SoundC3_EnterGiantRing_Header:
	smpsHeaderStartSong 2
	smpsHeaderVoice     SoundC3_EnterGiantRing_Voices
	smpsHeaderTempoSFX  $01
	smpsHeaderChanSFX   $02

	smpsHeaderSFXChannel cFM4, SoundC3_EnterGiantRing_FM4,	$0C, $00
	smpsHeaderSFXChannel cFM5, SoundC3_EnterGiantRing_FM5,	$00, $13

; FM4 Data
SoundC3_EnterGiantRing_FM4:
	smpsSetvoice        $01
	dc.b	nRst, $01, nA2, $08
	smpsSetvoice        $00
...
; FM5 Data
SoundC3_EnterGiantRing_FM5:
	smpsSetvoice        $02
	smpsModSet          $06, $01, $03, $FF
	dc.b	nRst, $0A

SoundC3_EnterGiantRing_Loop00:
	dc.b	nFs5, $06
	smpsLoop            $00, $05, SoundC3_EnterGiantRing_Loop00
	dc.b	nFs5, $17
	smpsStop

SoundC3_EnterGiantRing_Voices:
;	Voice $00
;	$30
