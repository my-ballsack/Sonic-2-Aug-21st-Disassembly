SoundD8_BonusBumper_Header:
	smpsHeaderStartSong 2
	smpsHeaderVoice     SoundD8_BonusBumper_Voices
	smpsHeaderTempoSFX  $01
	smpsHeaderChanSFX   $01

	smpsHeaderSFXChannel cFM5, SoundD8_BonusBumper_FM5,	$00, $07

; FM5 Data
SoundD8_BonusBumper_FM5:
	smpsSetvoice        $00
	dc.b	nD4, $06, nD4, $15
	smpsStop

SoundD8_BonusBumper_Voices:
;	Voice $00
;	$3C
