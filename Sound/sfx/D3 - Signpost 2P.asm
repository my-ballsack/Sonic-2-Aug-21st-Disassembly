SoundD3_Signpost2P_Header:
	smpsHeaderStartSong 2, 1
	smpsHeaderVoice     SoundD3_Signpost2P_Voices
	smpsHeaderTempoSFX  $01
	smpsHeaderChanSFX   $01

	smpsHeaderSFXChannel cFM5, SoundD3_Signpost2P_FM5,	$F5, $03

; FM5 Data
SoundD3_Signpost2P_FM5:
	smpsSetvoice        $00
