SoundCA_SpecStageEntry_Header:
	smpsHeaderStartSong 2
	smpsHeaderVoice     SoundCA_SpecStageEntry_Voices
	smpsHeaderTempoSFX  $01
	smpsHeaderChanSFX   $01

	smpsHeaderSFXChannel cFM5, SoundCA_SpecStageEntry_FM5,	$00, $02

; FM5 Data
SoundCA_SpecStageEntry_FM5:
	smpsSetvoice        $00
	smpsModSet          $01, $01, $5B, $02
	dc.b	nEb6, $65
	smpsStop

SoundCA_SpecStageEntry_Voices:
;	Voice $00
;	$20
