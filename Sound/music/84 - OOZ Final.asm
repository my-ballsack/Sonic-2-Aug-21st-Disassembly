OOZ_Final_Header:
	...
	smpsHeaderVoice     OOZ_Final_Voices
	smpsHeaderChan      $06, $03
	smpsHeaderTempo     $02, $D0

	smpsHeaderDAC       OOZ_Final_DAC
	smpsHeaderFM        OOZ_Final_FM1,	$F4, $0C
	smpsHeaderFM        OOZ_Final_FM2,	$F4, $09
	smpsHeaderFM        OOZ_Final_FM3,	$C4, $09
	smpsHeaderFM        OOZ_Final_FM4,	$F4, $10
	smpsHeaderFM        OOZ_Final_FM5,	$F4, $10
	smpsHeaderPSG       OOZ_Final_PSG1,	$D0, $04, $04, $00
	smpsHeaderPSG       OOZ_Final_PSG2,	$D0, $05, $04, $00
	smpsHeaderPSG       OOZ_Final_PSG3,	$FE, $07, $00, fTone_01

; FM1 Data
OOZ_Final_FM1:
	smpsSetvoice        $04
	smpsModSet          $02, $03, $01, $03
	smpsCall            OOZ_Final_Call02

OOZ_Final_Jump00:
	smpsSetvoice        $02
	smpsAlterVol        $FB
	smpsAlterPitch      $DC
	smpsCall            OOZ_Final_Call03
	smpsAlterVol        $05
	smpsAlterPitch      $24
	smpsSetvoice        $04
	smpsCall            OOZ_Final_Call04
	smpsSetvoice        $02
	smpsAlterVol        $FC
	smpsAlterPitch      $DC
	smpsCall            OOZ_Final_Call05
	smpsAlterVol        $04
	smpsAlterPitch      $24
	smpsAlterPitch      $E8
	smpsSetvoice        $05
	smpsAlterVol        $07
	smpsCall            OOZ_Final_Call06
	smpsAlterVol        $F9
	smpsAlterPitch      $18
	smpsJump            OOZ_Final_Jump00
...
OOZ_Final_Loop09:
	...
	smpsLoop            $01, $02, OOZ_Final_Loop09
	smpsReturn

OOZ_Final_Call05:
	smpsCall            OOZ_Final_Call07
...
OOZ_Final_Loop07:
	smpsCall            OOZ_Final_Call01
	dc.b	nRst, $12
	smpsCall            OOZ_Final_Call01
	dc.b	nRst, $06, nF4, $03, nRst, nF4, nG4
	smpsLoop            $00, $04, OOZ_Final_Loop07
...
OOZ_Final_Loop04:
	...
	smpsLoop            $00, $08, OOZ_Final_Loop04

OOZ_Final_Loop05:
	dc.b	nRst, $06, nBb5, $03, nBb5, nRst, nBb5, nRst, $06, nBb5, $09, nBb5
	dc.b	$03, nRst, $0C
	smpsAlterPitch      $02
	smpsLoop            $00, $03, OOZ_Final_Loop05
	smpsAlterPitch      $FA

OOZ_Final_Loop06:
	dc.b	nA5, $03, nRst
	smpsLoop            $00, $08, OOZ_Final_Loop06
	dc.b	nRst, $30
	smpsJump            OOZ_Final_Loop04
...
OOZ_Final_Loop08:
	...
	smpsLoop            $00, $0A, OOZ_Final_Loop08
	dc.b	nRst, $30
	smpsJump            OOZ_Final_Loop08
...
OOZ_Final_Loop00:
	...
	smpsLoop            $00, $0A, OOZ_Final_Loop00
	dc.b	nRst, $24, dSnare, $03, $03, dKick, $06
	smpsJump            OOZ_Final_Loop00
