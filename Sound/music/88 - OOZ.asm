OOZ_Header:
	...
	smpsHeaderFM        OOZ_FM1,	$F4, $06
	smpsHeaderFM        OOZ_FM2,	$F4, $0D
	smpsHeaderFM        OOZ_FM3,	$F4, $10
	smpsHeaderFM        OOZ_FM4,	$E8, $0E
	smpsHeaderFM        OOZ_FM5,	$F4, $10
	smpsHeaderPSG       OOZ_PSG1,	$D0, $04, $00, $00
	smpsHeaderPSG       OOZ_PSG2,	$D0, $04, $00, $00
	smpsHeaderPSG       OOZ_PSG3,	$C4, $05, $00, $00
...
OOZ_Loop09:
	smpsCall            OOZ_Call07
	smpsLoop            $00, $02, OOZ_Loop09

OOZ_Loop0A:
	smpsCall            OOZ_Call08
	smpsLoop            $00, $02, OOZ_Loop0A
	smpsSetvoice        $01
	smpsAlterNote       $00
	smpsAlterVol        $F9
	smpsCall            OOZ_Call0A
...
OOZ_Loop04:
	smpsCall            OOZ_Call07
	smpsLoop            $00, $02, OOZ_Loop04

OOZ_Loop05:
	smpsCall            OOZ_Call08
	smpsLoop            $00, $02, OOZ_Loop05
	smpsSetvoice        $01
	smpsCall            OOZ_Call09
